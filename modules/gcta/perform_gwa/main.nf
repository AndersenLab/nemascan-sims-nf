process GCTA_PERFORM_GWA {
    ...
    tuple path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.bed"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.bim"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.fam"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.map"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.nosex"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.ped"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.log"), path(gm), path(n_indep_tests)
    ...
    tuple path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.bed"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.bim"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.fam"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.map"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.nosex"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.ped"), path("TO_SIMS${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}.log"), path(gm), path(n_indep_tests), path(causal_variants), emit: plink
