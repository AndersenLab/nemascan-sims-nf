process GCTA_MAKE_GRM_LOCO {

    label 'gcta_make_grm'
    tag "${nqtl} ${rep} ${h2} ${effect} loco ${group}_${maf}"
    ...
    output:
    tuple val(group), val(maf), val(nqtl), val(effect), val(rep), val(h2), val('loco'), val(suffix), emit: params
    tuple path("TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_loco.grm.bin"), path("TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_loco.grm.N.bin"), path("TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_loco.grm.id"), emit: grm
    ...
    gcta64 --bfile TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group} \\
            --autosome --extract plink_snplist.txt --make-grm \\
            --out TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_loco \\
    ...
    GRM_PREFIX="TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_loco"
    ...
    stub:
    """
    touch TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_loco.grm.bin
    touch TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_loco.grm.N.bin
    touch TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_loco.grm.id
