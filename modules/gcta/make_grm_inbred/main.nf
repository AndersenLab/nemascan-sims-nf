process GCTA_MAKE_GRM_INBRED {

    label 'gcta_make_grm'
    tag "${nqtl} ${rep} ${h2} ${effect} inbred ${group}_${maf}"

    input:

    tuple val(group), val(maf), val(nqtl), val(effect), val(rep), val(h2), val(suffix)
    ...
    output:
    tuple val(group), val(maf), val(nqtl), val(effect), val(rep), val(h2), val('inbred'), val(suffix), emit: params
    tuple path("TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_inbred.grm.bin"), path("TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_inbred.grm.N.bin"), path("TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_inbred.grm.id"), emit: grm
    ...
    gcta64 --bfile TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group} \\
            --autosome --extract plink_snplist.txt --make-grm-inbred \\
            --out TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_inbred \\
    ...
    GRM_PREFIX="TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_inbred"
    ...
    stub:
    """
    touch TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_inbred.grm.bin
    touch TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_inbred.grm.N.bin
    touch TO_SIMS_${nqtl}_${rep}_${h2}_${maf}_${effect}_${group}_gcta_grm_inbred.grm.id
